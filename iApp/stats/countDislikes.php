<?php
  ...
  class countDislikes {
    ...
    function fromDay($day) {
        ...
        return $this->querys->COUNT(array("time_stamp" => array('$gte' => $startDay, '$lte' => $endDay)), 'Dislikes');
    }
    ...
    function fromMonth($month) {
        ...
        return $this->querys->COUNT(array("time_stamp" => array('$gte' => $startMonth, '$lte' => $endMonth)), 'Dislikes');
      }
  }
